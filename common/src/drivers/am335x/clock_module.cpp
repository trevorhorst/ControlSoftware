...
{
    LOG_INFO( "CLOCK MODULE GPIO MODULE MODES:" );
    LOG_INFO( "   GPIO0_MODULEMODE: %08X"
              , mMap.map()->mWkUp.wkup_gpio0_clkctrl.mModuleMode() );
    LOG_INFO( "   GPIO1_MODULEMODE: %08X"
              , mMap.map()->mPer.gpio1_clkctrl.mModuleMode() );
    LOG_INFO( "   GPIO2_MODULEMODE: %08X"
              , mMap.map()->mPer.gpio2_clkctrl.mModuleMode() );
    LOG_INFO( "   GPIO3_MODULEMODE: %08X"
